...
int new_id=0;
		try {
			...
			String sql = "select max(id) as max_id, count(*) as cnt from free";
		...
		sql_update="insert into free values("+new_id+","+new_id+",'"+multi.getParameter("title")+"','"+session.getAttribute("name")
