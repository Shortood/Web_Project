...
<jsp:include page="maintools.jsp"></jsp:include>
	<div id="wrap">
		<div id="main">
		<div class="notice">레시피 작성</div><br>
			<div class="contents">
			<form action="makerecipe-db.jsp" method="post" enctype="multipart/form-data">
				<table name="first">
					<tr>
						<td class="type_name">요리 이름</td>
						<td class="type_context"><input type="text" name="menu_name" pattern=".{1,}" maxlength="40"></td>
						<td><img src="DB에서 레시피 메인사진 가져와"><input type="file" class="file"
					...
					<tr>
						...
						<td class="type_context"><textarea name="menu_explain" pattern=".{1,}" maxlength="50"> </textarea></td>
					</tr>
				</table>
				...
				<table id="step_table">
					<tr>
						...
						<td class="type_context"><textarea name="step_explain"> </textarea></td>
						<td class="type_context"><input type="file" value="사진 추가" name="step_image0" accept="image/gif,image/jpeg,image/png"
				...
				<div class="submitbut"><input type="submit" value="글쓰기" /></div>
			</form>
		</div>
	</div>
</div>
