...
<jsp:include page="maintools.jsp"></jsp:include>
	...
	<div class="pageButton">
		...
		%>
		<a
			href="notice-search.jsp?page=<%=i%>&type=<%=type%>&search_form=<%=search%>"
			class="num selected"><%=i%></a>
		<%
		;
		}
		%>
	...
	%>
	<button class="writingbutton" onclick="location.href='notice-insert.jsp'">게시글 쓰기</button>
	<%
	break;
	}
	}
