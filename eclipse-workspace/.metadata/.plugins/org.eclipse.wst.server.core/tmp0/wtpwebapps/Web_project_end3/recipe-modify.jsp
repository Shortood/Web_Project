...
<jsp:include page="maintools.jsp"></jsp:include>
	<div id="wrap">
		<div id="main">
		<div class="notice">레시피 수정</div><br>
			<div class="contents">
			<form action="recipe-modify-db.jsp?id=<%=id%>" method="post"
				...
				<table name="first">
					<tr>
						...
						name="mainimage1" accept="image/gif,image/jpeg,image/png"></td>
					</tr>
					<tr>
						<td>&nbsp</td>
					</tr>
				...
				<table id="step_table">
					...
					<tr>
						...
						<td class="type_context"><input type="file"
							name="step_image<%=cnt%>" accept="image/gif,image/jpeg,image/png"
				...
				<div class="submitbut"><input type="submit" value="수정" /></div>
			</form>
		</div>
	</div>
</div>
