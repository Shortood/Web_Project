...
<body>
	...
	<center>
		...
		<br> <br> <img src="image/green_tree.gif"> <a
			href="board-insert.jsp?ref=<%=ref%>&flag=r">답글 쓰기</a> <img
			src="image/green_tree.gif"> <a
			href="board-modify-pwd.jsp?id=<%=id%>">게시글 수정</a> <img
			src="image/green_tree.gif"> <a
			href="board-delete-pwd.jsp?id=<%=id%>">게시글 삭제</a> <img
			src="image/green_tree.gif"> <a href="board-list.jsp">게시글 목록
			보기</a>
	</center>
</body>
</html>