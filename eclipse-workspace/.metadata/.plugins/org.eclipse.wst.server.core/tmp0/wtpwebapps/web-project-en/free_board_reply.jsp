	...
	<%
		...
		try{
			Class.forName("com.mysql.jdbc.Driver");
   			...
   			sql = "select max(id) as max_id , count(*) as cnt from free";
		...
		new_id++;
		sql = "insert into free values("+new_id+", '"+ref+"', NULL, '"+writer+"','"+writer_id+"', '"+content+"', NULL, NULL, NULL, NULL)";
		...
		sql = "select reply from free where id='"+ref+"'";
		...
		new_reply++;
		out.print(new_reply);
		sql = "update free set reply='"+new_reply+"' where id = '"+ref+"' and id = ref";
		...
		response.sendRedirect("free_board_post.jsp?id="+ref);
	%>
</body>
</html>